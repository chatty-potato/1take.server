 ...
 * @author gladhee
 *
 * Kakao OAuth2을 통해 자동적으로 실행하는 oauth2 login 적용
...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(
		...
		return httpSecurity
			...
			.authorizeHttpRequests(
				authorize -> authorize
					.requestMatchers(requestMatcher.pattern("/api/**"))
					.permitAll()
					.requestMatchers(requestMatcher.pattern("/api-docs/**"))
					.permitAll()
					.requestMatchers(requestMatcher.pattern("/v1/token"))
					.permitAll()
